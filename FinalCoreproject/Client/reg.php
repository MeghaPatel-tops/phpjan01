...
<body>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <input type="file"  id="password" name="profileimg">
...
if(isset($_POST['submit'])){
    ...
    if(isset($_FILES['profileimg']['tmp_name'])){
        ...
        $source = $tempname.$filename;
        move_uploaded_file($tempname,"images/".$filename);

        $query = "insert into users(username,email,password,profileimg) values('$username','$email','$password','$filename')";
