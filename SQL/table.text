CREATE TABLE  AGENTS( AGENT_CODE  CHAR(6) NOT NULL PRIMARY KEY,  AGENT_NAME  CHAR(40),  WORKING_AREA  CHAR(35),  COMMISSION  float(10,2),  PHONE_NO  CHAR(15),  COUNTRY  VARCHAR(25) );
...
CREATE TABLE ORDERS ( ORD_NUM FLOAT(6,0) NOT NULL PRIMARY KEY, ORD_AMOUNT FLOAT(12,2) NOT NULL, ADVANCE_AMOUNT FLOAT(12,2) NOT NULL, ORD_DATE DATE NOT NULL, CUST_CODE VARCHAR(6) NOT NULL REFERENCES CUSTOMER, AGENT_CODE CHAR(6) NOT NULL REFERENCES AGENTS, ORD_DESCRIPTION VARCHAR(60) NOT NULL );
